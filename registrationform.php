...
<head>
    ...
    <title>UPWIECON 2026 Registration</title>
...
<body>
    ...
    <div class="registration-container">
        <div class="form-header">
            <h1><i class="fas fa-graduation-cap"></i> UPWIECON 2026</h1>
            ...
            <form id="registrationForm" method="POST" action="close.php" enctype="multipart/form-data">
                        ...
                        <div class="checkbox-group">
                            <div class="checkbox-option">
                                <input type="checkbox" id="academicProfessional" name="chkProfessionalStatus[]"
                                    value="academic_professional" <?php echo isCheckboxChecked('chkProfessionalStatus', 'academic_professional'); ?>
                            ...
                            <div class="checkbox-option">
                                <input type="checkbox" id="student" name="chkProfessionalStatus[]" value="student" <?php echo isCheckboxChecked('chkProfessionalStatus', 'student'); ?>
                                    onchange="handleProfessionalStatusChange(this); calculateAmount(); updateCategoryFull(); validateProfessionalStatus();"
                                    disabled>
                                <label for="student">
                                    <i class="fas fa-user-graduate"></i> Student
                ...
                <div class="form-section">
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="ieeeYes" name="rdbIEEEMember" value="1" <?php echo isRadioSelected('rdbIEEEMember', '1'); ?>
                                        onchange="calculateAmount(); toggleIEEESection(); togglePaperUpload()" disabled>
                                    <label for="ieeeYes">Yes</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="ieeeNo" name="rdbIEEEMember" value="2" <?php echo isRadioSelected('rdbIEEEMember', '2'); ?>
                                        onchange="calculateAmount(); toggleIEEESection(); togglePaperUpload()" disabled>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="nationalityIndian" name="rdbNationality" value="1" <?php echo isRadioSelected('rdbNationality', '1'); ?> onchange="calculateAmount()"
                                        disabled>
                                    <label for="nationalityIndian">Indian</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="nationalityForeign" name="rdbNationality" value="2" <?php echo isRadioSelected('rdbNationality', '2'); ?> onchange="calculateAmount()"
                                        disabled>
                    ...
                    <div class="form-row">
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="earlyBirdYes" name="rdbEarlyBird" value="1" disabled <?php echo isRadioSelected('rdbEarlyBird', '1'); ?> onchange="calculateAmount()">
                                    <label for="earlyBirdYes">Yes (Before September 1 , 2026)</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="earlyBirdNo" name="rdbEarlyBird" value="2" disabled <?php echo isRadioSelected('rdbEarlyBird', '2'); ?> onchange="calculateAmount()"
                                        checked>
                                    <label for="earlyBirdNo">Regular (After September 1, 2026)</label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="radio-group">
                                <div class="radio-option">
                                    <input type="radio" id="nielitYes" name="rdbNielit" value="1" disabled <?php echo isRadioSelected('rdbNielit', '1'); ?>>
                                    <label for="nielitYes">Yes</label>
                                </div>
                                <div class="radio-option">
                                    <input type="radio" id="nielitNo" name="rdbNielit" value="2" disabled <?php echo isRadioSelected('rdbNielit', '2'); ?>>
                    ...
                    <div class="ieee-id-section" id="ieeeIdSection">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="txtIEEEId" name="txtIEEEId"
                                ...
                                placeholder="Enter your 8 or 9 digit IEEE Member ID" maxlength="9" pattern="[0-9]{8,9}"
                                disabled>
                ...
                <div class="form-section" id="paperSection"
                    ...
                    <div class="submit-section">
                        ...
                        <button type="button" class="submit-btn" id="submitBtn" data-bs-toggle="modal"
    ...
    <div class="modal fade" id="registrationClosedModal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content"
                style="border: 2px solid #f39c12; border-radius: 15px; box-shadow: 0 8px 32px rgba(70, 12, 82, 0.3); background: linear-gradient(135deg, #ffffff 0%, rgba(232, 217, 235, 0.99) 100%);">
                <div class="modal-header"
                    style="background: linear-gradient(135deg, rgba(70, 12, 82, 0.99) 0%, rgba(91, 2, 109, 0.99) 100%); border-bottom: 3px solid #f39c12; border-radius: 13px 13px 0 0; padding: 1.5rem;">
                    <h5 class="modal-title"
                        style="font-weight: 700; font-size: 1.25rem; letter-spacing: 0.5px; color: white;">Notice</h5>
                ...
                <div class="modal-body" style="padding: 2.5rem 1.5rem; text-align: center;">
                    <div style="font-size: 3rem; color: #f39c12; margin-bottom: 1rem;">
                        <div class="icon-wrapper">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill=`var(--primary-blue)`
                    ...
                    <h5
                        style="color: rgba(70, 12, 82, 0.99); font-weight: 700; font-size: 1.75rem; margin: 1rem 0; letter-spacing: 0.5px;">
                        Registration Closed</h5>
                    <p style="color: #2c3e50; font-size: 1rem; line-height: 1.6; margin-top: 1rem;">Registration for
                        this event is currently closed. Please contact support for more information.</p>
                </div>
                <div class="modal-footer"
                    style="border-top: 2px solid rgba(243, 156, 18, 0.46); padding: 1.5rem; background: rgba(255, 255, 255, 0.5); border-radius: 0 0 13px 13px; justify-content: center;">
                    <button type="button" class="btn" data-bs-dismiss="modal"
                        style="background: linear-gradient(135deg, #f39c12 0%, #e67e22 100%); border: none; color: white; font-weight: 600; padding: 0.7rem 2rem; border-radius: 8px; transition: all 0.3s ease; box-shadow: 0 4px 15px rgba(243, 156, 18, 0.3);">OK</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const pricingMatrix = {
            ...
            // ========== INDIAN DELEGATES - EARLY BIRD (Before 1 Aug 2026) - STUDENT ==========
            ...
            // ========== INDIAN DELEGATES - REGULAR (After 1-Aug-2026) - ACADEMIC/PROFESSIONAL ==========
            ...
            // ========== INDIAN DELEGATES - REGULAR (After 1-Aug-2026) - STUDENT ==========
            ...
            // ========== FOREIGN DELEGATES - EARLY BIRD (Before 1 Aug 2026) - ACADEMIC/PROFESSIONAL ==========
            ...
            // ========== FOREIGN DELEGATES - EARLY BIRD (Before 1 Aug 2026) - STUDENT ==========
            ...
            // ========== FOREIGN DELEGATES - REGULAR (After 1-Aug-2026) - ACADEMIC/PROFESSIONAL ==========
            ...
            // ========== FOREIGN DELEGATES - REGULAR (After 1-Aug-2026) - STUDENT ==========
