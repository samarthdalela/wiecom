                    ...
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <p class="lead textCenter">"InnovateHer-2026" is a STEM innovation competition organized
                                under the <span class="hide-ieee">IEEE</span> Student-Teacher and Research Engineer/Scientist (STAR) Program, aligned
                                with the <span class="hide-ieee">IEEE</span> UP Section WiE Affinity Group's mission to inspire the next generation of
                                girls in STEM.</p>
...
<ul>
        ...
        <li>Trophy</li>
        <li>Interaction with Women Engineers & <span class="hide-ieee">IEEE</span> Professionals</li>
    </ul>
                        ...
                        <div class="col-md-4">
                            <div class="award-item100">
                                ...
                                <ul>
                                     ...
                                     <li>Social media acknowledgement on <span class="hide-ieee">IEEE</span> UP Section WiE Affinity Group</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card100 animate-on-scroll100">
                            ...
                            <p><span class="hide-ieee">IEEE</span> TryEngineering STEM Grant Reviewers & <span class="hide-ieee">IEEE</span> UP Section Members to assist in outreach,
