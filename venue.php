                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <div class="transport-item">
                            ...
                            <p class="mb-2"><strong>Dehradun Airport</strong></p>
                            <p class="mb-2"><i class="fas fa-map-pin me-1"></i> Rishikesh Road, Dehradun</p>
                            <p class="mb-0"><i class="fas fa-taxi me-1"></i> Prepaid taxis and luxury cabs available</p>
                        </div>
                    </div>
                    <div class="col-md-6 mb-3">
                        <div class="transport-item">
                            <h5><i class="fas fa-train me-2"></i>Railway Station</h5>
                            <p class="mb-2"><strong>Dehradun Railway Station</strong></p>
                            <p class="mb-2"><i class="fas fa-map-pin me-1"></i> Nearest to conference venue</p>
                            <p class="mb-0"><i class="fas fa-car me-1"></i> Prepaid three-wheelers and taxis available
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div class="card venue-card">
            ...
            <div class="card-body p-4">
                <div class="weather-info">
                    <h4 class="mb-3"><i class="fas fa-calendar-alt me-2"></i>October End Weather</h4>
                    <p class="fs-5 mb-3">The weather in Dehradun is <span class="highlight-text">very pleasant</span> in
                        October End</p>
                        ...
                        <div class="col-md-8">
                            <div class="d-flex justify-content-around">
                                <div class="text-center">
                                    <h3 class="text-primary mb-0">11°C</h3>
                                    <small class="text-muted">Low</small>
                                </div>
                                <div class="text-center">
                                    <h3 class="text-danger mb-0">24°C</h3>
                ...
                <div class="d-flex align-items-start">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <ul class="places-list">
                            <li><i class="fas fa-map-marker-alt me-2"></i>Dehradun</li>
                            <li><i class="fas fa-mountain me-2"></i>Mussoorie</li>
                            <li><i class="fas fa-landmark me-2"></i>Lakhamandal</li>
                            <li><i class="fas fa-tree me-2"></i>Hanol</li>
                            <li><i class="fas fa-water me-2"></i>Asan Barrage</li>
                        </ul>
                    </div>
                </div>
            </div>
