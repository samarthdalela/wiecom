                                ...
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                            <i class="fas fa-user photo-placeholder"><img src="images\preetibansal.jpg" alt="Dr. Preeti Banzal" class='imagel'></i>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Neena phuja.png" alt="Dr. Neena Phuja" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Tripta Thakur.jpg" alt="Dr. Tripta Thakur" class='imagel'></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="speaker-details">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\SN Singh.jpg" alt="Professor S N Singh" class='imagel'></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="speaker-details">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Mohm. Rihan.jpg" alt="Professor Mohammad Rihan" class='imagel'></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="speaker-details">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Ram k Sharma.jpg" alt="Dr. Ram K Sharma" class='imagel'></i>
                                        </div>
                                    </div>
                                </div>
                                <div class="speaker-details">
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Sweta Khurana.jpg" alt="Ms. Shweta Khurana" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Dr. MAMTA.jpg" alt="Dr. Mamta Pant Abichandani" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Dr. manju.png" alt="Dr Manju Khari" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Asheesh Kumar.jpg" alt="Professor Asheesh Kumar Singh" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\Rishi.jpg" alt="Dr. Rishi Mohan Bhatnagar" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\abhijeet.png" alt="Mr. Abhijeet Sinha" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\astha.jpg" alt="Ms. Astha Kukreti" class='imagel'></i>
                        ...
                        <div class="col-lg-6 col-md-8">
                            <div class="speaker-card">
                                <div class="speaker-photo-section">
                                    <div class="photo-single">
                                        <div class="photo-overlay">
                                        <i class="fas fa-user photo-placeholder"><img src="images\swaweta.jpg" alt="Ms. Shaweta Berry" class='imagel'></i>
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\Mary.jpg" alt="Ms. Mary Ellen Randall" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\Celia.jpg" alt="Dr. Celia Shahnaz" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\Valentina.jpg" alt="Professor Valentina Emilia Balas" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\S. OBAIDAT.png" alt="Professor Mohammad S. Obaidat" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\AKSHAY KUMAR.jpg" alt="Professor Akshay Kumar Rathore" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\SWETA ANEHA.jpg" alt="Professor Sweta Sneha" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\MEGA NOVITA.png" alt="Mega Novita" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\THILINI.jpg" alt="Ms. Thilini De Silva" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\JEAN PIERRE.jpg" alt="Prof. Jean-Pierre Fontaine" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\PAOLO.jpg" alt="Prof. Paolo Ciancarini" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\ANG WEE.png" alt="Mr. Ang Wee Seng" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
        ...
        <div class="col-lg-6 col-md-8">
            <div class="speaker-card">
                <div class="speaker-photo-section">
                    <div class="photo-single">
                        <div class="photo-overlay">
                            <i class="fas fa-user photo-placeholder"><img src="images\Preeti Ohri Khemani.jpeg" alt="Preeti Ohri Khemani" class='imagel'></i>
                        </div>
                    </div>
                </div>
                <div class="speaker-details">
