...
<style>
    ...
    .registration-container50 {
        ...
        background: white;
        border-radius: 20px;
        box-shadow: 0 20px 60px rgba(255, 45, 149, 0.1);
        overflow: hidden;
        position: relative;
        margin-top: 30px;
    }
    ...
    .table-container50 {
        overflow-x: auto;
        border-radius: 15px;
        box-shadow: 0 10px 30px rgba(0, 150, 199, 0.1);
        background: white;
    }
    ...
    .sub-header50 {
        background: var(--gradient-blue-pink) !important;
        font-size: 0.9rem;
        opacity: 0.9;
    }
    ...
    @keyframes highlight {
        ...
        0%,
        100% {
            box-shadow: 0 0 0 0 rgba(255, 45, 149, 0.4);
        }
                        ...
                        <thead>
                            <tr>
                                ...
                                <th colspan="4" class="category-header50 early-bird50">Early Bird
                                    Registration<br>(Before 1 September 2026)</th>
