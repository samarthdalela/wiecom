        ...
        <section class="hero-section100">
            <div class="container">
                <div class="hero-content100 text-center">
                    <h1 class="main-title100">InnovateHer-2025</h1>
            ...
            <div class="container">
                ...
                <div class="card100 ">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <p class="lead textCenter">"InnovateHer-2025" is a STEM innovation competition organized
                                under the IEEE Student-Teacher and Research Engineer/Scientist (STAR) Program, aligned
                                with the IEEE UP Section WiE Affinity Group's mission to inspire the next generation of
                                girls in STEM.</p>
            ...
            <div class="container">
                ...
                <div class="awards-section100 animate-on-scroll100">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="award-item100">
                                <h5><i class="bi bi-person-badge-fill me-2"
                                        style="color: var(--accent-blue);"></i>Mentors</h5>
                                <ul>
                        ...
                        <div class="col-md-4">
                            <div class="award-item100">
                                ...
                                <ul>
                                    ...
                                    <li>Social media acknowledgement on IEEE UP Section WiE Affinity Group</li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card100 animate-on-scroll100">
                            <i class="bi bi-people icon100"></i>
                            <h4>IEEE Members & Reviewers</h4>
                            <p>IEEE TryEngineering STEM Grant Reviewers & IEEE UP Section Members to assist in outreach,
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p class="small opacity-75">
                            Organized under IEEE Student-Teacher and Research Engineer/Scientist (STAR) Program<br>
                            IEEE UP Section WiE Affinity Group | UPWIECON 2025
                        </p>
                    </div>
                </div>
            </div>
