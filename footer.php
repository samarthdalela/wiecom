...
<footer class="footer position-relative overflow-hidden">
    ...
    <div class="container position-relative py-3">
        ...
        <div class="row mt-4">
            <div class="col-12">
                <div class="text-center pt-3" style="border-top: 1px solid rgba(255, 255, 255, 0.12);">

                    <!-- Copyright Pill -->
                    <div class="d-inline-flex align-items-center px-4 py-2 rounded-pill mb-2"
                        style="background: rgba(255, 255, 255, 0.06); backdrop-filter: blur(10px);">
                        <i class="bi bi-c-circle me-2" style="color: #3b82f6;"></i>
                        <span style="color: #cbd5e1;">
                            Copyright © 2026 NIELIT. All Rights Reserved.
                        </span>
                    </div>
                    ...
                    <div>
                        <span style="color: #94a3b8; font-size: 0.9rem;">
                            Designed, Developed, and Maintained by NIELIT HQ
                        </span>
                    </div>
